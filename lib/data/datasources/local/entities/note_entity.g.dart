...
const NoteEntitySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.string,
      enumMap: _NoteEntitytypeEnumValueMap,
    ),
  ...
  links: {
    r'folder': LinkSchema(
      id: 2356721799975993078,
      name: r'folder',
      target: r'FolderEntity',
      single: true,
    ),
    r'tags': LinkSchema(
      id: 973851853337027106,
      name: r'tags',
      target: r'TagEntity',
      single: false,
    )
...
NoteEntity _noteEntityDeserialize(
  ...
  object.type =
      _NoteEntitytypeValueEnumMap[reader.readStringOrNull(offsets[8])] ??
          NoteType.richText;
...
P _noteEntityDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 7:
      return (reader.readString(offset)) as P;
    case 8:
      return (_NoteEntitytypeValueEnumMap[reader.readStringOrNull(offset)] ??
          NoteType.richText) as P;
    case 9:
      return (reader.readDateTime(offset)) as P;
    case 10:
      return (reader.readString(offset)) as P;
...
const _NoteEntitytypeEnumValueMap = {
  r'richText': r'richText',
  r'markdown': r'markdown',
  r'checklist': r'checklist',
};
const _NoteEntitytypeValueEnumMap = {
  r'richText': NoteType.richText,
...
List<IsarLinkBase<dynamic>> _noteEntityGetLinks(NoteEntity object) {
  return [object.folder, object.tags];
}
...
extension NoteEntityQueryFilter
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> orderIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> orderIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> orderEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'order',
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> orderGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> orderLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> orderBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> typeEqualTo(
    NoteType value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> typeGreaterThan(
    NoteType value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> typeLessThan(
    NoteType value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> typeBetween(
    NoteType lower,
    NoteType upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> typeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> typeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> typeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> typeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> typeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'type',
        value: '',
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> typeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'type',
        value: '',
...
extension NoteEntityQueryLinks
    on QueryBuilder<NoteEntity, NoteEntity, QFilterCondition> {
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> folder(
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> folderIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'folder', 0, true, 0, true);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> tags(
...
extension NoteEntityQuerySortBy
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByOrderDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteEntityQuerySortThenBy
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByOrderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.desc);
    });
  }
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }
...
extension NoteEntityQueryWhereDistinct
  ...
  QueryBuilder<NoteEntity, NoteEntity, QDistinct> distinctByOrder() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QDistinct> distinctByType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension NoteEntityQueryProperty
  ...
  QueryBuilder<NoteEntity, int?, QQueryOperations> orderProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
